...
class BasicUpdateBlock(nn.Module):
    def __init__(self, hidden_dim=128):
        ...
        self.integration = ReIntegration()
...
class ResidualBlock(nn.Module):
    def __init__(self, in_planes, planes, norm_fn='group', stride=1):
        ...
        self.conv1 = nn.Conv2d(in_planes, planes, kernel_size=3, padding=1, stride=1)
        ...
        if stride==1:
            ...
            self.downsample = nn.Sequential(
                nn.Conv2d(in_planes, planes, kernel_size=1, stride=1), self.norm3)
...
class PRNet(nn.Module):
    def __init__(self):
        ...
        self.fnet = BasicEncoder(input_dim=4, output_dim=128, norm_fn='instance', dropout=0)
